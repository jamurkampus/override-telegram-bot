...
const VAULT_API = process.env.VAULT_API || "https://override-telegram-bot.vercel.app/api/vault-response";
const GPT_API = process.env.GPT_API || "https://override-telegram-bot.vercel.app/api/ask-gpt";
